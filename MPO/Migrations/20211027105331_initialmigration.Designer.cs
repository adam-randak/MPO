...
namespace MPO.Migrations
{
    ...
    [Migration("20211027105331_initialmigration")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("MPO.Entities.Photo", b =>
                {
                    b.Property<int>("ID")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("MPO.Entities.Post", b =>
                {
                    b.Property<int>("ID")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("MPO.Entities.Post_Header", b =>
                {
                    b.Property<int>("ID")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("MPO.Entities.User", b =>
                {
            ...
            modelBuilder.Entity("MPO.Entities.Photo", b =>
                {
                    b.HasOne("MPO.Entities.Post", null)
                        .WithMany("PHOTOS")
            ...
            modelBuilder.Entity("MPO.Entities.Post", b =>
                {
                    b.HasOne("MPO.Entities.Post_Header", "HEADER")
                        .WithMany()
            ...
            modelBuilder.Entity("MPO.Entities.Post_Header", b =>
                {
                    b.HasOne("MPO.Entities.Photo", "MAIN_PHOTO")
                        .WithMany()
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("MPO.Entities.User", null)
                        .WithMany()
